      ...
      >
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mt-4">
            Thank you for visiting my portfolio. If you’re interested in my work
            and would like to discuss potential employment, please get in touch.
            I’m available for interviews and ready to start new challenges.
          </p>
        </motion.div>
